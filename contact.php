...
<html>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(images/background2.jpg)">
				...
				<div class="col-md-12 col-md-offset-0 text-left">
					<div class="row row-mt-15em">
						...
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">Any Question or other Message?</span>
							<h1>Get In Touch</h1>	
						</div>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3> Leave your idea
						...
						if(isset($_POST['send'])){
							...
							$insert=$conn->query("INSERT INTO contact values(null,'$email','$name','$subject','$message',now())");
									if ($insert) {
						echo "<span class='btn-success'>Thank u for contacting us, we get you soon.. </span>";
									
									}
									else{
						echo "<span class='btn-danger'>failed </span>";
				...
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="gtco-contact-info">
						...
						<ul>
							<li class="address"><a href="https://maps.app.goo.gl/L2AdhcgaZ8rQTLdK9" target="_blank">https://maps.app.goo.gl/L2AdhcgaZ8rQTLdK9</a></li>
							<li class="phone"><a href="tel://1234567920">+25078877339</a></li>
							<li class="email"><a href="mailto:info@yoursite.com">nyandungu@gmail.com</a></li>
				...
				<div class="col-md-3 col-md-push-1">
					<div class="gtco-widget">
						...
						<ul class="gtco-quick-contact">
							...
							<li><a href="#"><i class="icon-mail2"></i> nyandungu@gmail.com</a></li>
